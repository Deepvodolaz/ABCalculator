...
def popup_window(n1, c1, n2, c2):
    ...
    lblCommnt95 = tk.Label(window, text = "95% уверенность:", font = ('Helvetika', 10, 'bold'))
    lblCommnt95.place(x=25, y=25)
    
    if confidence_95:
        lblResult95 = tk.Label(window, text = "ДА", font = ('Helvetika', 12, 'bold'), fg = '#008800')
        lblResult95.place(x=160, y=25)
        
    else:
        lblResult95 = tk.Label(window, text = "НЕТ", font = ('Helvetika', 12, 'bold'), fg = '#ff0000')
        lblResult95.place(x=160, y=25)
        
    lblCommnt99 = tk.Label(window, text = "99% уверенность:", font = ('Helvetika', 10, 'bold'))
    lblCommnt99.place(x=25, y=65)
    
    if confidence_99:
        lblResult99 = tk.Label(window, text = "ДА", font = ('Helvetika', 12, 'bold'), fg = '#008800')
        lblResult99.place(x=160, y=65)
        
    else:
        lblResult99 = tk.Label(window, text = "НЕТ", font = ('Helvetika', 12, 'bold'), fg = '#ff0000')
        lblResult99.place(x=160, y=65)
    
    # Добавление кнопки закрытия окна
    btnClosePopup = tk.Button(window, text="Закрыть", font = ('Helvetika', 10, 'bold'), command=window.destroy)
    btnClosePopup.place(x=190, y=500, width=90, height=30)
